...
import catTypingGif from '../../../assets/gifs/cat-typing.gif';
import { blockTypeToBlockName, useToolbarState } from '../../../context';
import { useModal } from '../../../hooks';
import { Dropdown, DropdownColorPicker, DropdownItem } from '../../../ui';
import {
  clearFormatting,
  formatBulletList,
  formatCheckList,
...
import { INSERT_IMAGE_COMMAND, InsertImageDialog, InsertInlineImageDialog } from '../images';
import { SHORTCUTS } from '../shortcuts/shortcuts';

import { InsertEquationDialog } from '../equation';
import { INSERT_PAGE_BREAK } from '../page-break';
                ...
                <DropdownItem
                  onClick={() =>
                    activeEditor.dispatchCommand(INSERT_TABLE_COMMAND, {
                      columns: '5',
                      rows: '3',
                      includeHeaders: { columns: false, rows: false },
                    })
                  }
                  className="item"
                >
